window.lunrData = {
  "index": {
    ...
    "documentStore": {
      "store": {
        ...
        "api.course.app.html#getAssignmentLaunchURL": [
          "api.course.app#getassignmentlaunchurl",
          "app#getassignmentlaunchurl",
          "course.app#getassignmentlaunchurl",
          "function",
          "get",
        ...
        "api.course.discussionTopic.html": [
          "api.course.discussiontop",
          "class",
          "cours",
          "course.discussiontop",
          "discuss",
          "discussiontop",
          "function",
          "interact",
        ...
        "api.course.gradebookColumn.html#updateEntry": [
                                                                            ...
                                                                            "u": {
                                                                              ...
                                                                              "r": {
                                                                                ...
                                                                                "l": {
                                                                                  "docs": {
                                                                                    "api.course.app.html#getAssignmentLaunchURL": {
                                                                                      "ref": "api.course.app.html#getAssignmentLaunchURL",
                                                                                      "tf": 1075
                                                                                    }
                                                                                  }
                                                                                }
                                                  ...
                                                  "t": {
                                                    ...
                                                    "o": {
                                                      ...
                                                      "p": {
                                                        "docs": {
                                                          "api.course.discussionTopic.html": {
                                                            "ref": "api.course.discussionTopic.html",
                                                            "tf": 1100
                                                          }
                                                        }
                                                      }
                                                                              ...
                                                                              "t": {
                                                                                ...
                                                                                "r": {
                                                                                  ...
                                                                                  "i": {
                                                                                    "docs": {
                                                                                      "api.course.gradebookColumn.html#updateEntry": {
                                                                                        "ref": "api.course.gradebookColumn.html#updateEntry",
                                                                                        "tf": 1075
                                                                                      },
                                                                                      "api.course.gradebookColumn.html#updateEntries": {
  ...
  "store": {
    ...
    "api.account.html#list": {
      "id": "api.account.html#list",
      "kind": "function",
      "title": "list() → {Promise.&lt;Array.&lt;Object&gt;&gt;}",
      "longname": "api.account#list",
      "name": "list",
      "tags": "api.account#list account#list list",
      "summary": "",
      "description": "Get the list of accounts"
    },
    "api.account.html#listAdmins": {
      "id": "api.account.html#listAdmins",
      "kind": "function",
      "title": "listAdmins( options ) → {Promise.&lt;Array.&lt;Object&gt;&gt;}",
      "longname": "api.account#listAdmins",
      "name": "listAdmins",
      "tags": "api.account#listAdmins account#listAdmins listAdmins",
      "summary": "",
      "description": "Gets the list of admins in an account"
    },
    "api.account.html#get": {
      "id": "api.account.html#get",
      "kind": "function",
      "title": "get( options ) → {Promise.&lt;Object&gt;}",
      "longname": "api.account#get",
      "name": "get",
    ...
    "api.course.app.html#getNavLaunchURL": {
      ...
      "kind": "function",
      "title": "getNavLaunchURL( options ) → {Promise.&lt;Object&gt;}",
      "longname": "api.course.app#getNavLaunchURL",
      "name": "getNavLaunchURL",
      "tags": "api.course.app#getNavLaunchURL course.app#getNavLaunchURL app#getNavLaunchURL getNavLaunchURL",
      "summary": "",
      "description": "Gets a sessionless navigation LTI launch URL"
    },
    "api.course.app.html#getAssignmentLaunchURL": {
      "id": "api.course.app.html#getAssignmentLaunchURL",
      "kind": "function",
      "title": "getAssignmentLaunchURL( options ) → {Promise.&lt;Object&gt;}",
      "longname": "api.course.app#getAssignmentLaunchURL",
      "name": "getAssignmentLaunchURL",
      "tags": "api.course.app#getAssignmentLaunchURL course.app#getAssignmentLaunchURL app#getAssignmentLaunchURL getAssignmentLaunchURL",
      "summary": "",
      "description": "Gets a sessionless navigation LTI launch URL"
    },
    "api.course.assignment.html": {
    ...
    "api.course.assignment.html#updateGrade": {
      "id": "api.course.assignment.html#updateGrade",
      "kind": "function",
      "title": "updateGrade( options ) → {Promise.&lt;Object&gt;}",
      "longname": "api.course.assignment#updateGrade",
      "name": "updateGrade",
      "tags": "api.course.assignment#updateGrade course.assignment#updateGrade assignment#updateGrade updateGrade",
      "summary": "",
      "description": "Updates a student's grade and/or comment"
    },
    "api.course.assignment.html#updateGrades": {
    ...
    "api.course.assignment.html#createOverride": {
      ...
      "summary": "",
      "description": "Create assignment override. Note that if any dates (dueAt, unlockAt, or lockAt) are left out, they will be set to \"none\" for the target(s) of this override. If dueAt is omitted, the target(s) will have no deadline. If unlockAt is omitted, the target(s) will immediately be able to see the assignment (even if everyone else has to wait until the unlockAt date). If lockAt is omitted, the target(s) will be able to submit at any time in the future (even if everyone else can't submit because their lock date has passed). In short, it is not recommended to omit dates that are defined in the assignment."
    },
    "api.course.assignment.html#updateOverride": {
    ...
    "api.course.discussionTopic.html": {
      "id": "api.course.discussionTopic.html",
      "kind": "class",
      "title": ".course.discussionTopic",
      "longname": "api.course.discussionTopic",
      "name": "discussionTopic",
      "tags": "api.course.discussionTopic course.discussionTopic discussionTopic",
      "summary": "",
      "description": "Functions for interacting with discussion topics within courses",
      "body": ""
    },
    "api.course.gradebookColumn.html": {
    ...
    "api.course.gradebookColumn.html#updateEntry": {
      "id": "api.course.gradebookColumn.html#updateEntry",
      "kind": "function",
      "title": "updateEntry( options ) → {Promise.&lt;Object&gt;}",
      "longname": "api.course.gradebookColumn#updateEntry",
      "name": "updateEntry",
      "tags": "api.course.gradebookColumn#updateEntry course.gradebookColumn#updateEntry gradebookColumn#updateEntry updateEntry",
      "summary": "",
      "description": "Update a specific entry in a gradebook column"
    },
    "api.course.gradebookColumn.html#updateEntries": {
