...
var ECatEnrollmentTerm = /** @class */ (function (_super) {
    __extends(ECatEnrollmentTerm, _super);
    function ECatEnrollmentTerm() {
     ...
     */
    ECatEnrollmentTerm.prototype.list = function (opts, config) {
     ...
     */
    ECatEnrollmentTerm.prototype.get = function (opts, config) {
    ...
    ;
    return ECatEnrollmentTerm;
}(EndpointCategory_1.default));
/*------------------------------------------------------------------------*/
/*                                 Export                                 */
/*------------------------------------------------------------------------*/
exports.default = ECatEnrollmentTerm;
//# sourceMappingURL=ECatEnrollmentTerm.js.map