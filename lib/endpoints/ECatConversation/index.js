...
// Endpoint category
var ECatConversation = /** @class */ (function (_super) {
    __extends(ECatConversation, _super);
    function ECatConversation() {
     ...
     */
    ECatConversation.prototype.create = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            var recipientBatches, conversationBatches;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        recipientBatches = [[]];
                        opts.recipientIds.forEach(function (recipientId) {
                        ...
                        return [4 /*yield*/, Promise.all(recipientBatches.map(function (recipients) {
                                ...
                                return _this.visitEndpoint({
                                    ...
                                    path: "".concat(API_PREFIX_1.default, "/conversations"),
                                    method: 'POST',
                                });
                            }))];
                    case 1:
                        conversationBatches = _a.sent();
                        // Concatenate into one long list
                        return [2 /*return*/, [].concat.apply([], conversationBatches)];
                }
            });
        });
    };
    ;
    return ECatConversation;
}(EndpointCategory_1.default));
/*------------------------------------------------------------------------*/
/*                                 Export                                 */
/*------------------------------------------------------------------------*/
exports.default = ECatConversation;
