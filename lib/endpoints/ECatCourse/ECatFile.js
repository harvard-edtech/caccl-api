...
// Endpoint category
var ECatFile = /** @class */ (function (_super) {
    __extends(ECatFile, _super);
    function ECatFile() {
     ...
     */
    ECatFile.prototype.list = function (opts, config) {
        var _a;
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/files"),
                        method: 'GET',
                    })];
            });
        });
...
/*                                 Export                                 */
/*------------------------------------------------------------------------*/
exports.default = ECatFile;
//# sourceMappingURL=ECatFile.js.map