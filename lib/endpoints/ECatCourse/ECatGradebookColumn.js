...
// Endpoint category
var ECatGradebookColumn = /** @class */ (function (_super) {
    __extends(ECatGradebookColumn, _super);
    function ECatGradebookColumn() {
     ...
     */
    ECatGradebookColumn.prototype.list = function (opts, config) {
        var _a;
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/custom_gradebook_columns"),
                        method: 'GET',
                        params: {
     ...
     */
    ECatGradebookColumn.prototype.get = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @returns {Promise<CanvasCustomColumn>} Canvas CustomColumn {@link https://canvas.instructure.com/doc/api/custom_gradebook_columns.html#CustomColumn}
     */
    ECatGradebookColumn.prototype.update = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/custom_gradebook_columns/").concat(opts.columnId),
                        method: 'PUT',
                        params: {
     ...
     * @returns {Promise<CanvasCustomColumn>} Canvas CustomColumn {@link https://canvas.instructure.com/doc/api/custom_gradebook_columns.html#CustomColumn}
     */
    ECatGradebookColumn.prototype.create = function (opts, config) {
        var _a;
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
     ...
     * @returns {Promise<CanvasCustomColumn>} Canvas CustomColumn {@link https://canvas.instructure.com/doc/api/custom_gradebook_columns.html#CustomColumn}
     */
    ECatGradebookColumn.prototype.delete = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
     ...
     */
    ECatGradebookColumn.prototype.listEntries = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/custom_gradebook_columns/").concat(opts.columnId, "/data"),
                        method: 'GET',
                        params: {
                            include_hidden: true,
                        },
     ...
     */
    ECatGradebookColumn.prototype.updateEntry = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                ...
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/custom_gradebook_columns/").concat(opts.columnId, "/data/").concat(opts.studentId),
                        method: 'PUT',
                        params: {
                            column_data: {
     ...
     */
    ECatGradebookColumn.prototype.updateEntries = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.visitEndpoint({
                                ...
                                path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/custom_gradebook_column_data"),
                                method: 'PUT',
                                params: {
    ...
    return ECatGradebookColumn;
}(EndpointCategory_1.default));
/*------------------------------------------------------------------------*/
/*                                 Export                                 */
/*------------------------------------------------------------------------*/
exports.default = ECatGradebookColumn;
//# sourceMappingURL=ECatGradebookColumn.js.map