            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 10:
                        ...
                        console.log('Headers', headers, rows);
                        ignoredHeaders = [
                            'section',
                            'section_id',
                            'section_sis_id',
