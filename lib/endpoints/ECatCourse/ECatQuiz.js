...
var parseCSV_1 = __importDefault(require("../../shared/helpers/parseCSV"));
// Endpoint category
var ECatQuiz = /** @class */ (function (_super) {
    ...
    ECatQuiz.prototype.getQuizStudentAnalysisReport = function (opts, config) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var quizReport, progressId, waitDurationSec, checkIntervalSec, numChecks, timedOut, i, progress, generatedReport, fileURL, reportData, _d, headers, rows, nameColIndex, idColIndex, submittedColIndex, attemptColIndex, numCorrectColIndex, numIncorrectColIndex, scoreColIndex, ignoredHeaders, questionHeaders, i, header, questionCols, i, _e, index, text, questionId, questionColIndex, questionText, questionScoreColIndex, questionTotalScore, studentReports, parsedReport;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 1:
                        ...
                        waitDurationSec = 30;
                        checkIntervalSec = 0.5;
                        numChecks = (waitDurationSec / checkIntervalSec);
                        timedOut = true;
                        i = 0;
                        _f.label = 2;
                    case 2:
                        if (!(i < numChecks)) return [3 /*break*/, 6];
                        return [4 /*yield*/, this.visitEndpoint({
                                config: config,
                    ...
                    case 6:
                        if (timedOut) {
                            throw new caccl_error_1.default({
                                ...
                                code: ErrorCode_1.default.QuizReportGenerationTimeout,
                            });
                        }
                        return [4 /*yield*/, this.visitEndpoint({
                                config: config,
                    ...
                    case 7:
                        generatedReport = _f.sent();
                        fileURL = generatedReport.file.url;
                        return [4 /*yield*/, fetch(fileURL)];
                    case 8: return [4 /*yield*/, (_f.sent()).text()];
                    case 9:
                        reportData = _f.sent();
                        return [4 /*yield*/, (0, parseCSV_1.default)(reportData)];
                    case 10:
                        _d = _f.sent(), headers = _d.headers, rows = _d.rows;
                        ignoredHeaders = [
                            'section',
                            'section_id',
                            'section_sis_id',
                        ...
                        for (i = 0; i < questionHeaders.length - 1; i += 2) {
                            _e = questionHeaders[i], index = _e.index, text = _e.text;
