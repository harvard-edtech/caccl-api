...
var ECatCourse = /** @class */ (function (_super) {
    ...
    ECatCourse.prototype.migrateContent = function (opts) {
        return __awaiter(this, void 0, void 0, function () {
            var sourceCourseId, destinationCourseId, include, dateShiftOptions, _a, timeoutMs, _b, fileIds, _c, quizIds, _d, assignmentIds, _e, announcementIds, _f, discussionTopicsIds, _g, moduleIds, _h, pageIds, _j, rubricIds, contentMapping, params, oldStart, oldEnd, newStart, newEnd, _k, daySubstitutionMap_1, dayNumberSubstitutionMap_1, assignmentMap, contentMigration, workflowState, migrationIssuesCount, CHECK_INTERVAL_MS_1, numIterations, i, status_1, migrationIssues_1, errorsAsText, errorMessage, err_1, sourceAssignments, assignmentGroupMap, sourceAssignmentGroups, destinationAssignmentGroups, sourceCourse, applyAssignmentGroupWeights, _loop_1, this_1, i, i, sourceAssignment, assignmentGroupId, destinationAssignmentGroupId, destinationAssignmentId, i, sourceAssignmentGroup, destinationAssignmentGroupId, destinationNeverDrop;
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 9: return [4 /*yield*/, this.visitEndpoint({
                            path: "".concat(API_PREFIX_1.default, "/courses/").concat(destinationCourseId, "/content_migrations/").concat(contentMigration.id, "/asset_id_mapping"),
                            action: 'get content mapping',
                            method: 'GET',
                        })];
                    case 10:
                        // mapping source assignment id to destination assignment id
                        contentMapping = _l.sent();
                    ...
                    case 12: return [4 /*yield*/, this.api.course.assignment.list({
                    ...
                    case 16:
                        ...
                        _l.label = 17;
                    case 17:
                        if (!(i < sourceAssignmentGroups.length)) return [3 /*break*/, 20];
                    ...
                    case 20:
                        ...
                        _l.label = 21;
                    case 21:
                        if (!(i < sourceAssignments.length)) return [3 /*break*/, 24];
                    ...
                    case 24:
                        ...
                        _l.label = 25;
                    case 25:
                        if (!(i < sourceAssignmentGroups.length)) return [3 /*break*/, 28];
                        ...
                        if (sourceAssignmentGroup.rules.never_drop) {
                            destinationNeverDrop = sourceAssignmentGroup.rules.never_drop.map(function (id) { return Number.parseInt(assignmentMap[id], 10); });
                        }
                    ...
                    case 27:
                        i++;
                        return [3 /*break*/, 25];
                    case 28: return [2 /*return*/, contentMapping];
                }
            });
        });
    };
