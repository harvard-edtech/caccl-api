            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 18:
                        ...
                        _l.label = 19;
                    case 19:
                        if (!(i < sourceAssignmentGroups.length)) return [3 /*break*/, 24];
                        sourceId = sourceAssignmentGroups[i].id;
                        return [4 /*yield*/, this.api.course.assignmentGroup.get({
                                assignmentGroupId: sourceId,
                                courseId: sourceCourseId,
                            })];
                    case 20:
                        sourceAssignmentGroup = _l.sent();
                        return [4 /*yield*/, this.api.course.assignmentGroup.create({
                                courseId: destinationCourseId,
                    ...
                    case 21:
                        destinationAssignmentGroup = _l.sent();
                    ...
                    case 24:
                        ...
                        _l.label = 25;
                    case 25:
                        if (!(i < sourceAssignments.length)) return [3 /*break*/, 29];
                    ...
                    case 29:
                        ...
                        _l.label = 30;
                    case 30:
                        if (!(i < sourceAssignmentGroups.length)) return [3 /*break*/, 33];
