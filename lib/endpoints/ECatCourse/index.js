...
var ECatCourse = /** @class */ (function (_super) {
     ...
     */
    ECatCourse.prototype.waitForContentMigration = function (opts) {
        return __awaiter(this, void 0, void 0, function () {
            var CHECK_INTERVAL_MS, numIterations, i, status_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        CHECK_INTERVAL_MS = 500;
                        numIterations = Math.ceil(opts.timeoutMs / CHECK_INTERVAL_MS);
                        i = 0;
                        _a.label = 1;
                    case 1:
                        if (!(i < numIterations)) return [3 /*break*/, 5];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.visitEndpoint({
                                path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/content_migrations/").concat(opts.contentMigrationId),
                                action: 'check the status of a content migration',
                                method: 'GET',
                            })];
                    case 3:
                        status_1 = _a.sent();
                        if (opts.workflowStatesToWaitFor.includes(status_1.workflow_state)) {
     ...
     */
    ECatCourse.prototype.throwOnMigrationIssues = function (opts) {
        return __awaiter(this, void 0, void 0, function () {
            var migrationIssues, errorsAsText, errorMessage;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // Nothing to report
                        ...
                        return [4 /*yield*/, this.visitEndpoint({
                                path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/content_migrations/").concat(opts.contentMigrationId, "/migration_issues"),
                                action: 'get migration issues',
                                method: 'GET',
                            })];
                    case 1:
                        migrationIssues = _a.sent();
                        ...
                        if (opts.migrationIssuesCount === 1) {
                            ...
                            errorsAsText = "".concat(migrationIssues[0].description, " and ").concat(migrationIssues[1].description);
                        }
                        else {
                            errorsAsText = (migrationIssues
     ...
     *   call (overwrites defaults that were included when api was initialized)
     */
    ECatCourse.prototype.migrateCourseSettings = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, sourceCourseId, destinationCourseId, _b, timeoutMs, contentMigration, pausedStatus, status_2, err_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = opts.sourceCourseId, sourceCourseId = _a === void 0 ? this.defaultCourseId : _a, destinationCourseId = opts.destinationCourseId, _b = opts.timeoutMs, timeoutMs = _b === void 0 ? 60000 : _b;
                        _c.label = 1;
                    case 1:
                        _c.trys.push([1, 7, , 8]);
                        return [4 /*yield*/, this.visitEndpoint({
                    ...
                    case 2:
                        contentMigration = _c.sent();
                        return [4 /*yield*/, this.waitForContentMigration({
                    ...
                    case 5:
                        status_2 = _c.sent();
                        return [4 /*yield*/, this.throwOnMigrationIssues({
                                courseId: destinationCourseId,
                                contentMigrationId: contentMigration.id,
                                migrationIssuesCount: status_2.migration_issues_count,
                            })];
                    case 6:
                        _c.sent();
                        return [3 /*break*/, 8];
    ...
    ECatCourse.prototype.migrateContent = function (opts) {
        return __awaiter(this, void 0, void 0, function () {
            var sourceCourseId, destinationCourseId, include, dateShiftOptions, _a, timeoutMs, _b, fileIds, _c, quizIds, _d, assignmentIds, _e, announcementIds, _f, discussionTopicsIds, _g, moduleIds, _h, pageIds, _j, rubricIds, shiftDatesOpts, params, _k, daySubstitutionMap_1, contentMigration, status_3, err_2;
            return __generator(this, function (_l) {
                switch (_l.label) {
                    case 0:
                        ...
                        shiftDatesOpts = (dateShiftOptions.dateHandling === DateHandling_1.DateHandlingType.ShiftDates
                            ? dateShiftOptions
                            : undefined);
                        params = {
                            migration_type: 'course_copy_importer',
                            ...
                            'select[files]': utils_1.default.includeTruthyElementsExcludeIfEmpty(fileIds),
                            'select[quizzes]': utils_1.default.includeTruthyElementsExcludeIfEmpty(quizIds),
                            'select[assignments]': utils_1.default.includeTruthyElementsExcludeIfEmpty(assignmentIds),
                            'select[announcements]': utils_1.default.includeTruthyElementsExcludeIfEmpty(announcementIds),
                            'select[discussion_topics]': utils_1.default.includeTruthyElementsExcludeIfEmpty(discussionTopicsIds),
                            'select[modules]': utils_1.default.includeTruthyElementsExcludeIfEmpty(moduleIds),
                            'select[pages]': utils_1.default.includeTruthyElementsExcludeIfEmpty(pageIds),
                            'select[rubrics]': utils_1.default.includeTruthyElementsExcludeIfEmpty(rubricIds),
                            // If we remove dates we don't need to provide start and end dates,
                            // but if we shift dates, we do
                            'date_shift_options[remove_dates]': utils_1.default.includeIfTruthy(dateShiftOptions.dateHandling === DateHandling_1.DateHandlingType.RemoveDates),
                            'date_shift_options[shift_dates]': utils_1.default.includeIfTruthy(dateShiftOptions.dateHandling === DateHandling_1.DateHandlingType.ShiftDates),
                            'date_shift_options[old_start_date]': utils_1.default.includeIfDate(shiftDatesOpts === null || shiftDatesOpts === void 0 ? void 0 : shiftDatesOpts.oldStart),
                            'date_shift_options[old_end_date]': utils_1.default.includeIfDate(shiftDatesOpts === null || shiftDatesOpts === void 0 ? void 0 : shiftDatesOpts.oldEnd),
                            'date_shift_options[new_start_date]': utils_1.default.includeIfDate(shiftDatesOpts === null || shiftDatesOpts === void 0 ? void 0 : shiftDatesOpts.newStart),
                            'date_shift_options[new_end_date]': utils_1.default.includeIfDate(shiftDatesOpts === null || shiftDatesOpts === void 0 ? void 0 : shiftDatesOpts.newEnd),
                        };
                        // Translate input (day of week map) to number-based params that Canvas uses
                        if (shiftDatesOpts) {
                            _k = shiftDatesOpts.daySubstitutionMap, daySubstitutionMap_1 = _k === void 0 ? {} : _k;
                            Object.keys(daySubstitutionMap_1).forEach(function (k) {
                                var key = k;
                                var originalDayNum = DateHandling_1.dayOfWeekToNumber[key];
                                var replacementDayNum = DateHandling_1.dayOfWeekToNumber[daySubstitutionMap_1[key]];
                                params["date_shift_options[day_substitutions][".concat(originalDayNum, "]")] = replacementDayNum;
                            });
                        }
                        _l.label = 1;
                    case 1:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.throwOnMigrationIssues({
                                courseId: destinationCourseId,
                                contentMigrationId: contentMigration.id,
                                migrationIssuesCount: status_3.migration_issues_count,
                            })];
                    case 4:
                        _l.sent();
                        return [3 /*break*/, 6];
                    case 5:
                        err_2 = _l.sent();
                        if (err_2 instanceof caccl_error_1.default) {
                            // Rethrow the error (it's already in the right format)
                            throw err_2;
                        }
                        // An unknown error occurred. Throw a new error
