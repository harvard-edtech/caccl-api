...
var ECatAssignmentGroup = /** @class */ (function (_super) {
    __extends(ECatAssignmentGroup, _super);
    function ECatAssignmentGroup() {
     ...
     */
    ECatAssignmentGroup.prototype.list = function (opts, config) {
        var _a;
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/assignment_groups"),
                        method: 'GET',
                    })];
            });
        });
     ...
     */
    ECatAssignmentGroup.prototype.get = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/assignment_groups/").concat(opts.assignmentGroupId),
                        method: 'GET',
                        params: {
     ...
     * @returns {Promise<CanvasAssignmentGroup>} Canvas AssignmentGroup {@link https://canvas.instructure.com/doc/api/assignment_groups.html#AssignmentGroup}
     */
    ECatAssignmentGroup.prototype.update = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var dropLowest, dropHighest, neverDrop, rules;
            return __generator(this, function (_b) {
                dropLowest = opts.dropLowest, dropHighest = opts.dropHighest, neverDrop = opts.neverDrop;
                if ((dropLowest && dropLowest > 0)
                ...
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        params: {
                            ...
                            rules: utils_1.default.includeIfTruthy(rules),
                        },
                    })];
            });
        });
     ...
     * @returns {Promise<CanvasAssignmentGroup>} Canvas AssignmentGroup {@link https://canvas.instructure.com/doc/api/assignment_groups.html#AssignmentGroup}
     */
    ECatAssignmentGroup.prototype.create = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
     ...
     * @returns {Promise<CanvasAssignmentGroup>} Canvas AssignmentGroup {@link https://canvas.instructure.com/doc/api/assignment_groups.html#AssignmentGroup}
     */
    ECatAssignmentGroup.prototype.delete = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
    ...
    return ECatAssignmentGroup;
}(EndpointCategory_1.default));
/*------------------------------------------------------------------------*/
/*                                 Export                                 */
/*------------------------------------------------------------------------*/
exports.default = ECatAssignmentGroup;
//# sourceMappingURL=ECatAssignmentGroup.js.map