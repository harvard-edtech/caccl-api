...
// Endpoint category
var ECatAnalytics = /** @class */ (function (_super) {
    __extends(ECatAnalytics, _super);
    function ECatAnalytics() {
     ...
     */
    ECatAnalytics.prototype.getStudentParticipationData = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/analytics/users/").concat(opts.studentId, "/activity"),
                        method: 'GET',
                    })];
            });
        });
     ...
     */
    ECatAnalytics.prototype.getStudentMessagingData = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/analytics/users/").concat(opts.studentId, "/communication"),
                        method: 'GET',
                    })];
            });
        });
     ...
     */
    ECatAnalytics.prototype.listDailyActivitySummaries = function (opts, config) {
        var _a;
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/analytics/activity"),
                        method: 'GET',
                    })];
            });
        });
     ...
     */
    ECatAnalytics.prototype.listAssignmentSummaries = function (opts, config) {
        var _a;
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/analytics/assignments"),
                        method: 'GET',
                    })];
            });
        });
     ...
     */
    ECatAnalytics.prototype.listStudentSummaries = function (opts, config) {
        var _a;
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
                        ...
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat((_a = opts.courseId) !== null && _a !== void 0 ? _a : this.defaultCourseId, "/analytics/student_summaries"),
                        method: 'GET',
                    })];
            });
        });
     ...
     */
    ECatAnalytics.prototype.getStudentSummary = function (opts, config) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                return [2 /*return*/, this.visitEndpoint({
    ...
    return ECatAnalytics;
}(EndpointCategory_1.default));
/*------------------------------------------------------------------------*/
/*                                 Export                                 */
/*------------------------------------------------------------------------*/
exports.default = ECatAnalytics;
//# sourceMappingURL=ECatAnalytics.js.map