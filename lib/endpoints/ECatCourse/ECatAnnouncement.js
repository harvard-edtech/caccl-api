...
// Endpoint category
var ECatAnnouncement = /** @class */ (function (_super) {
    __extends(ECatAnnouncement, _super);
    function ECatAnnouncement() {
     ...
     */
    ECatAnnouncement.prototype.create = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
                        action: 'create an announcement in a course',
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/discussion_topics"),
                        method: 'POST',
                        params: {
                            title: opts.title,
     ...
     */
    ECatAnnouncement.prototype.list = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
                        action: 'get the list of announcements in a course',
                        path: "".concat(API_PREFIX_1.default, "/announcements"),
                        method: 'GET',
                        params: {
                            context_codes: [
                                "course_".concat(opts.courseId),
                            ],
                            start_date: (opts.queryLastSixMonths
                                ? (new Date(Date.now() - 15552000000)).toISOString()
                                : utils_1.default.includeIfDate(opts.startDate)),
                            end_date: (opts.queryLastSixMonths
                                ? (new Date()).toISOString()
                                : utils_1.default.includeIfDate(opts.endDate)),
                            active_only: utils_1.default.includeIfBoolean(opts.onlyIncludeActive),
                        },
                    })];
            });
        });
    };
    return ECatAnnouncement;
}(EndpointCategory_1.default));
/*------------------------------------------------------------------------*/
/*                                 Export                                 */
/*------------------------------------------------------------------------*/
exports.default = ECatAnnouncement;
//# sourceMappingURL=ECatAnnouncement.js.map