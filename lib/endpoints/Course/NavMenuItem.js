...
// Endpoint category
var NavMenuItem = /** @class */ (function (_super) {
     ...
     */
    NavMenuItem.prototype.list = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
                        action: 'get the list of nav menu items in a course',
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/tabs"),
                        method: 'GET',
                    })];
            });
        });
     ...
     */
    NavMenuItem.prototype.update = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
                                ...
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, this.visitEndpoint({
                                                ...
                                                params: params,
                                                path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/tabs/").concat(tab.id),
                                                method: 'PUT',
                                            })];
                                    case 1:
                                        results = _a.sent();
