...
var Page = /** @class */ (function (_super) {
     ...
     */
    Page.prototype.list = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
                        action: 'get the list of pages in a course',
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/pages"),
                        method: 'GET',
                    })];
            });
        });
     ...
     */
    Page.prototype.get = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
                        action: 'get info on a specific page in a course',
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/pages/").concat(opts.pageURL),
                        method: 'GET',
                    })];
            });
        });
     ...
     * @returns {Promise<CanvasPage>} Canvas Page {@link https://canvas.instructure.com/doc/api/pages.html#Page}
     */
    Page.prototype.update = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
     ...
     * @returns {Promise<CanvasPage>} Canvas Page {@link https://canvas.instructure.com/doc/api/pages.html#Page}
     */
    Page.prototype.create = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
     ...
     * @returns {Promise<CanvasPage>} Canvas Page {@link https://canvas.instructure.com/doc/api/pages.html#Page}
     */
    Page.prototype.delete = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
