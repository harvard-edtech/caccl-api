...
// Endpoint category
var DiscussionTopic = /** @class */ (function (_super) {
     ...
     */
    DiscussionTopic.prototype.list = function (opts, config) {
     ...
     */
    DiscussionTopic.prototype.create = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
     ...
     */
    DiscussionTopic.prototype.delete = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
                        action: 'delete a discussion topic from a course',
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/discussion_topics/").concat(opts.topicId),
                        method: 'DELETE',
                    })];
            });
        });
     ...
     * @returns {Promise<CanvasDiscussionTopic>} A Canvas Discussion Topic {@link https://canvas.instructure.com/doc/api/discussion_topics.html#DiscussionTopic}
     */
    DiscussionTopic.prototype.listEntries = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
                        action: 'list entries in a discussion topic in a course',
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/discussion_topics/").concat(opts.topicId, "/entries"),
                        method: 'GET',
                    })];
            });
        });
...
/*                                 Export                                 */
/*------------------------------------------------------------------------*/
exports.default = DiscussionTopic;
//# sourceMappingURL=DiscussionTopic.js.map