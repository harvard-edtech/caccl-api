...
// Endpoint category
var Rubric = /** @class */ (function (_super) {
     ...
     */
    Rubric.prototype.list = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
                        action: 'list all the rubrics in a course',
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/rubrics"),
                        method: 'GET',
                    })];
            });
        });
     ...
     */
    Rubric.prototype.get = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
                        action: 'get info on a specific rubric in a course',
                        path: "".concat(API_PREFIX_1.default, "/courses/").concat(opts.courseId, "/rubrics/").concat(opts.rubricId),
                        method: 'GET',
                        params: {
     ...
     * @returns {Promise<CanvasRubric>} Canvas Rubric {@link https://canvas.instructure.com/doc/api/rubrics.html#Rubric}
     */
    Rubric.prototype.createFreeFormGradingRubricInAssignment = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
