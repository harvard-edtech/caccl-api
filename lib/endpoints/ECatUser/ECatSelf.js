...
var ECatSelf = /** @class */ (function (_super) {
    __extends(ECatSelf, _super);
    function ECatSelf() {
     ...
     */
    ECatSelf.prototype.getProfile = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
                        action: 'get info on the current user',
                        path: "".concat(API_PREFIX_1.default, "/users/self/profile"),
                        method: 'GET',
                    })];
            });
        });
     ...
     */
    ECatSelf.prototype.listCourses = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.visitEndpoint({
                        config: config,
...
/*                                 Export                                 */
/*------------------------------------------------------------------------*/
exports.default = ECatSelf;
//# sourceMappingURL=ECatSelf.js.map