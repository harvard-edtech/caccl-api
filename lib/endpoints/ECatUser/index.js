...
var ECatSelf_1 = __importDefault(require("./ECatSelf"));
// Endpoint category
var ECatUser = /** @class */ (function (_super) {
     ...
     */
    function ECatUser(initPack) {
        var _this = _super.call(this, initPack) || this;
        // Initialize subcategory
        _this.self = new ECatSelf_1.default(initPack);
        return _this;
    }
    /*------------------------------------------------------------------------*/
    /*                               Endpoints:                               */
     ...
     */
    ECatUser.prototype.listEmails = function (opts, config) {
     ...
     */
    ECatUser.prototype.listCourses = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     */
    ECatUser.prototype.search = function (opts, config) {
        return __awaiter(this, void 0, void 0, function () {
