...
var waitForCompletion = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var timeoutMs, stopTime, progressURL, checkPath, refreshMs, maxNumChecks, i, statusResponse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                timeoutMs = (60000 * (opts.timeoutMin || 2));
                stopTime = (Date.now() + timeoutMs);
                progressURL = new url_parse_1.default(opts.progress.url);
                checkPath = progressURL.pathname;
