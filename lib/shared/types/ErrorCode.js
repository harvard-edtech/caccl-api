...
(function (ErrorCode) {
    ...
    // course
    // > updatePublishState
    ErrorCode["CoursePublishedStateNotUpdated"] = "CAPI31";
    // course.assignment
    // > createSubmission
    ...
    ErrorCode["MigrationTimeout"] = "CAPI26";
    ErrorCode["MigrationIssue"] = "CAPI28";
    ErrorCode["CouldNotFindDestinationAssignment"] = "CAPI29";
    ErrorCode["CouldNotFindDestinationAssignmentGroup"] = "CAPI30";
    // course.quiz reports
    ErrorCode["QuizReportNoProgress"] = "CAPI32";
    ErrorCode["QuizReportGenerationFailed"] = "CAPI33";
    ErrorCode["QuizReportFormattingUnexpected"] = "CAPI34";
    ErrorCode["QuizReportGenerationTimeout"] = "CAPI35";
})(ErrorCode || (ErrorCode = {}));
