            ...
            switch (_k.label) {
                case 0:
                    ...
                    fetchPage = function (pageNumber, pageBookmark) { return __awaiter(void 0, void 0, void 0, function () {
                        var updatedParamsWithBookmark, response, errors_1, parsed, parsedBody, canvasError, page, nextPageBookmark_1, link, links, nextPageLink, urlPart, url, urlObj, urlParams, err_1, newError, newUmbrella, currUmbrella, parts;
                        var _a;
                            ...
                            switch (_b.label) {
                                case 0:
                                    ...
                                    if (pageBookmark) {
                                        ...
                                        updatedParamsWithBookmark.page = "bookmark:".concat(pageBookmark);
                                    }
                                    _b.label = 1;
                                case 1:
                                    _b.trys.push([1, 3, , 4]);
