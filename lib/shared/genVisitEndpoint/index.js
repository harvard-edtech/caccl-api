    ...
    var visitEndpoint = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_l) {
            switch (_l.label) {
                case 0:
                    ...
                    updatedParams = (0, removeUndefinedValues_1.default)(__assign(__assign({}, params), { 
                        ...
                        per_page: (method === 'GET'
                            ...
                            : undefined) }));
                    canvasHost = ((_f = config.canvasHost) !== null && _f !== void 0 ? _f : defaults.canvasHost);
                    numRetries = ((_g = config.numRetries) !== null && _g !== void 0 ? _g : defaults.numRetries);
                    maxPages = ((_h = config.maxPages) !== null && _h !== void 0 ? _h : defaults.maxPages);
                    pathPrefix = ((_k = (_j = config.pathPrefix) !== null && _j !== void 0 ? _j : defaults.pathPrefix) !== null && _k !== void 0 ? _k : '');
                    onNewPage = config.onNewPage;
                    fetchPage = function (pageNumber) { return __awaiter(void 0, void 0, void 0, function () {
                        var pageParams, response, errors_1, parsed, parsedBody, canvasError, page, anotherPageExists, link, err_1, newError, newUmbrella, currUmbrella, parts;
                            ...
                            switch (_a.label) {
                                ...
                                case 2:
                                    ...
                                    try {
                                        ...
                                        anotherPageExists = (String(link !== null && link !== void 0 ? link : '')
                                            .split(',')
                                            .some(function (linkPart) {
                                            return (
                ...
                case 2:
                    _e = _l.sent(), page = _e.page, anotherPageExists = _e.anotherPageExists;
                    // Add the page to the list
                    pages.push(page);
