...
var genVisitEndpoint = function (defaults) {
    ...
    var visitEndpoint = function (opts) { return __awaiter(void 0, void 0, void 0, function () {
        var path, _a, config, _b, method, _c, action, _d, params, pagePostProcessor, updatedParams, canvasHost, numRetries, maxPages, pathPrefix, onNewPage, fetchPage, pages, hasNextPage, nextPageNumber, nextPageBookmark, pageResults, page, allowedToFetchAnotherPage, allData;
        var _e, _f, _g, _h, _j;
            ...
            switch (_k.label) {
                case 0:
                    ...
                    fetchPage = function (pageNumber, pageBookmark) { return __awaiter(void 0, void 0, void 0, function () {
                        var updatedParamsWithNewPage, response, errors_1, parsed, parsedBody, canvasError, page, nextPageBookmark_1, hasNextPage_1, link, links, nextPageLink, urlPart, url, urlObj, urlParams, pageParam, isBookmark, err_1, newError, newUmbrella, currUmbrella, parts;
                        var _a, _b;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    updatedParamsWithNewPage = (0, fast_clone_1.default)(updatedParams);
                                    // Clone params to avoid mutating original
                                    updatedParamsWithNewPage.page = (pageBookmark
                                ...
                                case 2:
                                    ...
                                    hasNextPage_1 = false;
                                    console.log('Looking for next page', response.headers);
                                    try {
                                        ...
                                        hasNextPage_1 = !!nextPageLink;
                                        if (hasNextPage_1 && nextPageLink) {
                                ...
                                case 3:
                                    err_1 = _c.sent();
                                    newError = err_1;
                                    if (!((_b = err_1) !== null && _b !== void 0 ? _b : {}).isCACCLError) {
                ...
                case 1:
                    if (!(nextPageNumber === 1
                        || hasNextPage)) return [3 /*break*/, 3];
                    return [4 /*yield*/, fetchPage(nextPageNumber || 1, nextPageBookmark)];
                case 2:
                    pageResults = _k.sent();
